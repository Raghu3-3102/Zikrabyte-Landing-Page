...
import LineWithBlock from '../../../../public/assets/img/LineWithBlock.png';
...
export const Home = () => {
  ...
  return (
    <div className='home_outer'>
      <div className='home_section flex items-center flex-col  w-full '>
      ...
      {/* <Image src={LineWithBlock} alt="line" /> */}
          </div>        
      {/*
      ...
      <div className="black_box">
        <div className="black_element"></div>
      </div>
      ...
      <div className="swiper-wrapper mt-12 sm:mt-4">  
        <Image style={{display:'inline-block'}} src={swiperWrapper} alt="swiper-wrapepr" />
        <Image style={{display:'inline-block'}} src={swiperWrapper} alt="swiper-wrapepr" />
      </div>
      </div>
    </div>
