...
export const Team = () => {
  ...
  <div className={styles.team}>
    <h1 className={styles.teamHeading}>Our teams are led by bold creative vision and multi-disciplinary experience</h1>
  </div>
    ...
    <h2 className={styles.ch2}>
      ...
      <div className={styles.pen}>
        ...
        <div className={styles.mid}>
          <div className={styles.limi}></div>
        </div>
        <div className={styles.last}></div>
      </div>Talk
    </h2>
  </div>
  <p className={styles.lp1}>Share your ideas, and we&apos;ll create engaging designs.</p>
  <div className={styles.letsContainer}>
    <div>
      <h2 className={styles.lh1}>Discover us</h2>
      <p className={styles.lp2}>We are here to help you; <br />
      ...
      <p className={styles.lp}>jayanagar 9th nlovk, bangalore, karnataka.</p>
      <p className={styles.lp}>Feel free to get in touch with us through our channels:</p>
      <h2 className={styles.lh}>email us</h2>
      <p className={styles.lp}>flick@flick.com</p>
      <h2 className={styles.lh}>Call Us</h2>
      <p className={styles.lp}>+971-4-576-6770 <br />+971-55-983-7007</p>
    </div>
    <div>
      <Image className={styles.gr} src="/assets/images/group.png" alt="group" width={700} height={648.9} />
    </div>
  </div>
  <Circle />
</div>
